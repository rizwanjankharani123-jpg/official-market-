        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-3 space-y-3 text-left">
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li>
                <button onClick={() => handleNav('services')} className="hover:text-cyan-400 transition-colors flex items-center gap-1.5 cursor-pointer">
                  <ChevronRight className="w-3.5 h-3.5 text-cyan-500" />
                  <span>Engineering Services</span>
                </button>
              </li>
              <li>
                <button onClick={() => handleNav('custom-project')} className="hover:text-cyan-400 transition-colors flex items-center gap-1.5 cursor-pointer">
                  <ChevronRight className="w-3.5 h-3.5 text-cyan-500" />
                  <span>Custom Project Request</span>
                </button>
              </li>
              <li>
