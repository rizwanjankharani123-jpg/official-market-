...
export const ProductEditorModal: React.FC<ProductEditorModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.price || formData.price < 0) {
      setErrorMessage('Valid software price is required.');
      return;
    }
            ...
            <div className="space-y-4 animate-in fade-in">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="flex items-center gap-2 pt-6">
                  ...
                  />
                  <label htmlFor="featuredCheck" className="text-xs font-mono text-slate-300 cursor-pointer">
                    Feature on Homepage
                  </label>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 rounded-2xl bg-slate-900 border border-white/10 space-y-2">
                  <label className="block text-xs font-mono text-cyan-300 font-bold">
                    Software / Binary Price (PKR) *
                  </label>
                  <p className="text-[10px] text-slate-400">Price in PKR for compiled binary / APK ready to install.</p>
                  <input
                    type="number"
                    required
                ...
                <div className="p-4 rounded-2xl bg-slate-900 border border-white/10 space-y-2">
                  ...
                  <p className="text-[10px] text-slate-400">Price in PKR for complete uncompiled source repository.</p>
                  <input
                    type="number"
